-- =====================================================
-- FIX AUDIT FUNCTION V2 - Drop and Recreate
-- =====================================================

-- Step 1: Drop the existing function
DROP FUNCTION IF EXISTS get_deals_with_audit_info();

-- Step 2: Check what columns actually exist in deals table
SELECT column_name 
FROM information_schema.columns 
WHERE table_name = 'deals' 
ORDER BY column_name;

-- Step 3: Create corrected audit function with proper columns
...
SELECT 'Audit function recreated successfully!' as status; 